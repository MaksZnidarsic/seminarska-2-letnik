...
Za matematično analizo privzamemo naslednje splošne oznake: z $\N$ označujemo množico naravnih, z $\Z$ množico celih in z $\R$ množico realnih števil, z $\I$ označujemo enotski interval, z $\B^n$ $n$-kroglo, s $\S^n$ $n$-sfero in s $\T^n$ $n$-torus. Poleg tega s $\F_n$ označimo prosto grupo reda $n$.
...
V prihodnje se ukvarjamo predvsem z zankami, kljub temu pa vseeno večino trditev dokažemo v splošnem, saj nam to nam to dokazov ne oteži.
...
Saj nas zanimajo predvsem poti, nas te popolnoma splošne definicije lahko pripeljejo le tako daleč. S tem v mislih moramo definicijo homotopnosti rahlo posplošiti, da bo primerna tudi za homotopnost poti. Problem namreč nastane s potmi v povezanih prostorih, saj so v njih vse homotopne. Recimo, da je $X$ povezan s potmi in $\alpha, \beta$ poti v $X$. Ker obstaja neka pot $\sigma$ od $\alpha(1)$ do $\beta(0)$, lahko homotopijo med njima konstuiramo tako, da pot $\alpha$ po tirnici $\sigma$ preprosto povlečemo na mesto poti $\beta$.
...
\begin{zgled}
    Poglejmo si tri poti v podprostoru ravnine, kot kaže slika \ref{homotopija-poti}. Ni se težko prepričati, da sta poti $\alpha$ in $\beta$ homotopni, saj si lahko predstavljamo, kako bi ena zdrsela v drugo, kot bi jo s prstom potisnili v željeni položaj. Po drugi strani pa nobena izmed $\alpha$ in $\beta$ ni homtopna $\gamma$. Razlog je luknja v sredini prostora, ki preprečuje katerikoli od njiju zlesti na mesto poti $\gamma$. Da bi to dosegli, bi ju morali ali pretrgati ali pa v procesu transformacije začasno premakniti eno od krajišč, oba ta primera pa sta po definiciji homotopnosti poti nemogoča.
...
\begin{zgled}
    Panima nas, kaj je fundamentalna grupa mnogoterosti $\T^2$. Naj bo $x \in \T^2$. Izgleda, kot da ima $\pi_1(\T^2, x)$ natanko dva generatorja — zanko, ki gre po obodu luknje, in zanko, ki obkroži biskvit, kot kaže slika \ref{krof} —, poleg tega pa noben izmed njiju ni nilpotenten, torej bo $\pi_1(\T^2, x)$ neskončna. Preverimo, ali je komutativna tj. ali je izomorfna $\Z^2$.
    ...
    Naj bosta $\alpha, \beta$ generatorja $\pi_1(\T^2, x)$. Če si torus predstavljamo kot kvocient $\I^2$, je lahko videti, da velja $\alpha\beta \simeq \beta\alpha$, saj, če dobljeno zanko primemo, ko se ponovno vrne v $x$, in jo povlečemo skozi kot $\I^2$, se zaradi topologije torusa spet pojavi v nasprotnem. Iz tega sledi, da je fundamentalna grupa torusa komutativna, od tod pa lahko zaključimo, da velja $\pi_1(\T^2, x) \cong \Z^2$.
\end{zgled}
...
\begin{zgled}
    ...
    Preslikave $\phi_s$ so bile konstruirane na način, da se vsa navijanja, ki padejo, ko odstranimo žebelj $s$, nahajajo v podgrupi $\ker \phi_s$. Od tu sledi, da bodo vse rešitve ležale v preseku vseh, saj so to ravno vsa obešanja, ki padejo, ko odstranimo kateregakoli izmed žebljev. Torej je $\bigcap_{s \in S} \ker \phi_s$ množica rešitev problema obešanja slike.
